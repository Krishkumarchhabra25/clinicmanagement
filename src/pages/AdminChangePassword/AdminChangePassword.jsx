...
const AdminChangePassword = () => {
  ...
  return (
    ...
    <div onClick={()=>navigate("/login")} className="flex flex-col justify-center p-9 bg-white rounded-3xl w-[663px] max-md:w-full">
 <button
...
>
  <ArrowLeft className="w-6 h-6 text-white" />
      ...
      <div className="flex flex-col items-center self-center text-2xl font-medium text-black">
        ...
        />
        <div className="mt-5">Chnage Password</div>
      </div>
      <ChnagePsaswordComponentes />
    </div>
  </div>
  )
}
