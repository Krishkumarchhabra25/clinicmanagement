...
import ChangeSupportPasswordComponent from "../../components/SupportChnagePassword/SupportChnagePassword";

const ChnageSupportPassword = () => {
...
>
  <ArrowLeft className="w-6 h-6 text-white" />
     ...
     <ChangeSupportPasswordComponent />
    </div>
  </div>
  )
}

export default ChnageSupportPassword
